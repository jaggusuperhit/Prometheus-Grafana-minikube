...
def metrics():
    ...
    model_prediction_success_rate = round(random.uniform(80, 100),2) # Success rate in percentage
    ...
    return promotheus_metrics, 200,{"Content-Type": "text/plain ; charset=utf-8"}
